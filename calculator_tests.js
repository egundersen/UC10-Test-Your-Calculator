...
//US10: As a user in basic algebra, I want to be able to convert radians to degrees.
...
//US11: As a user in basic algebra, I want to be able to convert radians to degrees.
...
//US12: As a user who is too dumb to be able to remember that I input 4 in the calculator, I want to be able to store this value so that I may remember it for later.
